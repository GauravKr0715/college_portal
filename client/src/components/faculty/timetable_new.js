...
import { getTimeTable } from "../../services/faculty";
                                ...
                                <>
                                  ...
                                  >
                                    <div className={"clickable-title multiline-head" + (slot.class_id === 'ABC123' ? 'back-grey' : null)}>
                                      {slot.subject_name}
                                      <div className="small-data">
                                      {(slot.section === 'ABCXYZ')?'N/A':`${slot.section}`}
                                      </div>
                                      <div className="small-data">
                                      {(slot.section === 'ABCXYZ')?'N/A':`${(slot.subject_type=== 1) ? "Theory":(slot.subject_type=== 2)? "Lab": "Tutorial"}`}
                                    </div>
                                    </div>
                                  </TableCell>
                                  {
