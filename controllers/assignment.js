...
const addAssignmentSubmission = async (details, roll_no) => {
  try {
    ...
    feed_obj.to = assignment_data.faculty_id;
    feed_obj.content = `<b>${student_details.full_name}</b> added a new submission for the assignment titled <b>${assignment_data.title}</b> for your <b>${assignment_data.subject}</b> class`;
